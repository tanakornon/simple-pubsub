...
describe("Events", () => {
    ...
    beforeEach(() => {
        ...
        refillSubscriber.register(publishSubscribeService);
        saleSubscriber.register(publishSubscribeService);

        publishSubscribeService.subscribe("refill", refillSubscriber);
